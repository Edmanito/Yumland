...
// Index id => nom pour affichage rapide
$indexUsers = [];
foreach ($dataUsers['utilisateurs'] as $u) {
    $indexUsers[$u['id']] = $u['infos']['prenom'] . ' ' . $u['infos']['nom'];
}

function afficherCartes($commandes, $btnLabel, $btnClass, $nextStatut, $indexUsers = []) {
    ...
    <article class="order-card">
        ...
        <div class="card-client">
            <span class="client-name"><?= htmlspecialchars($indexUsers[$cmd['id_client']] ?? $cmd['id_client']) ?></span>
    ...
    <main class="kanban">
        ...
        <div class="kanban-col">
            ...
            <div class="cards-list">
                <?php afficherCartes($attente, 'Prendre en charge', 'primary', 'en_preparation', $indexUsers); ?>
        ...
        <div class="kanban-col">
            ...
            <div class="cards-list">
                <?php afficherCartes($cuisine, 'Marquer prêt', 'success', 'pret', $indexUsers); ?>
        ...
        <div class="kanban-col">
            ...
            <div class="cards-list">
                <?php afficherCartes($pret, 'Envoyer en livraison', 'gold', 'en_livraison', $indexUsers); ?>
                <?php if (empty($pret)): ?>
                    <p style="color:#444;font-size:0.8rem;text-align:center;padding:20px;">Aucune commande</p>
                <?php endif; ?>
            </div>
                ...
                <article class="order-card">
                    ...
                    <div class="card-items">
                        <div class="livreur-info">
                            ...
                            <span><?= htmlspecialchars($indexUsers[$cmd['id_livreur']] ?? 'Non assigné') ?></span>
                        </div>
                    </div>
                    <div class="card-actions">
