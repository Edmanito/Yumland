            ...
            <div class="items-grid">
                ...
                <article class="dish-card signature">
                    <div class="dish-content">
                        ...
                        <a href="../actions/ajouter_panier.php?id=<?= $m['id'] ?>&type=menu" class="btn-add-cart">AJOUTER AU PANIER</a>
                    </div>
                </article>
                <?php endforeach; ?>
            </div>
            ...
            <div class="items-grid">
                ...
                <article class="dish-card" data-title="<?= htmlspecialchars($p['nom']) ?>">
                    ...
                    <div class="dish-content">
                        ...
                        <a href="../actions/ajouter_panier.php?id=<?= $p['id'] ?>&type=plat" class="btn-add-cart">AJOUTER AU PANIER</a>
                    </div>
                </article>
                <?php endforeach; ?>
            </div>
